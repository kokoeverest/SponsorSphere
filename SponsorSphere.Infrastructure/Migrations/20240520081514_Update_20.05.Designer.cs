...
namespace SponsorSphere.Infrastructure.Migrations
{
    ...
    [Migration("20240520081514_Update_20.05")]
    partial class Update_2005
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.BlogPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2016, 6, 11, 21, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.Picture", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Modified = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(5078),
                            Url = "https://drive.google.com/file/d/1PVTg8DDjnKEu2L_M2Oe4YBicC_Cvpy4C/view?usp=sharing"
                        },
                        new
                        {
                            Id = 2,
                            Modified = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(5080),
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.Sponsorship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SponsorId = 3,
                            Amount = 2000m,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4890),
                            Level = 2
                        });
                });
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.SportEvent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            Country = 732800,
                            EventDate = new DateTime(2019, 9, 8, 21, 0, 0, 0, DateTimeKind.Utc),
                            EventType = 2,
                            Finished = false,
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Country = 732800,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4251),
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.Athlete", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "32e89955-4020-4c65-9783-d8e5ed1d43df",
                            Country = 732800,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4442),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "test@mail.bg",
                            EmailConfirmed = false,
                            FaceBookLink = "",
                        ...
                        new
                        {
                            Id = 6,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a4476200-3720-4919-95e7-0311068f841e",
                            Country = 732800,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4633),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.SponsorCompany", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8ae18837-671f-44fa-89b2-5033585a40ca",
                            Country = 732800,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4716),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "lidl@mail.bg",
                            EmailConfirmed = false,
                            FaceBookLink = "",
                        ...
                        new
                        {
                            Id = 4,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d4a4ebf8-9461-4115-817f-0287352e2b60",
                            Country = 2921044,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4732),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("SponsorSphere.Domain.Models.SponsorIndividual", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 8,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bfa688d5-9e73-49e6-8944-87d3fc924397",
                            Country = 732800,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4785),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 7,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a632f973-3b32-4980-b844-f079afb1a2fb",
                            Country = 2077456,
                            Created = new DateTime(2024, 5, 20, 8, 15, 13, 543, DateTimeKind.Utc).AddTicks(4817),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "michael@bg.gb",
                            EmailConfirmed = false,
                            FaceBookLink = "",
                            ...
                            TwoFactorEnabled = false,
                            Website = "",
                            BirthDate = new DateTime(1975, 3, 4, 22, 0, 0, 0, DateTimeKind.Utc),
                            LastName = "Uzunov"
                        });
                });
